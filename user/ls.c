...
void ls(char *path) {
  ...
  // It should usually be DIRSIZ, but since cgroups' file names are longer, we set it to 64.
  char temp_name_buffer[MAX(MAX(MAX_CGROUP_FILE_NAME_LENGTH, MAX_PROC_FILE_NAME_LENGTH), DIRSIZ) + 1]; 
